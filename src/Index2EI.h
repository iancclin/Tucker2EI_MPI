...
#ifndef TUCKER2EI__INDEX2EI_H_
#define TUCKER2EI__INDEX2EI_H_
...
public:
   ...
   * @param j
   */
  Index2EI(int i, int j)
    : i(i)
    , j(j)
  {}

  bool
  operator==(const Index2EI &idx)
  {
    return ((i == idx.i && j == idx.j) || (i == idx.j && j == idx.i));
  }

  int i, j;
};

#endif // TUCKER2EI__INDEX2EI_H_
